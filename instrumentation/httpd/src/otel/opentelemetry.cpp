...
const nostd::string_view kResourceServiceName = "service.name";
...
void initTracer()
{
  ...
  resAttrs[kResourceServiceName] = kResourceDefaultServiceName; // set the default service name. Config will overwrite this.
